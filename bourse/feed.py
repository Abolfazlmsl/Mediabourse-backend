    ...
    try:
        ...
        if day_last < d_last:
            ...
            for i in range(len(df_days_of_week)):
                print(df_days_of_week['<VOL>'][index_start_day + i])
            ...
            candle_week = [int(last_entry_date), int(0), int(df_days_of_week['<OPEN>'][index_start_day])
        ...
        # todo: current day greater than next week candle
        else:
            print('greater than')
